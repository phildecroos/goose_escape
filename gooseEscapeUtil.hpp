////// Begining of gooseEscapeUtil.cpp //////
...
const int MYSTERY = int('?'); //Mystery box (declared here for use in Actor class)

// constants for mystery box speeds
